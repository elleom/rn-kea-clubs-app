...
export const EVENTS = [
  ...
  new Event('2', 'Event','UCL', 'Go city!', 'https://i.ytimg.com/vi/4iwH75lgMTM/maxresdefault.jpg',new Date( 2021, 12,13,5,30 ).toString(), new Date( 2021, 12,13,5,30 ).toString(), 'Sports & Beers', 'Sports Club'),
  new Event('3', 'Event','Paintball', 'The organizationName here ','https://funguide.dk/wp-content/uploads/2014/09/Paintball.jpg', new Date( 2020, 12,13,5,30 ).toString(), new Date( 2021, 12,13,5,30 ).toString(), 'Paintball Arena', 'KEA Something')
];