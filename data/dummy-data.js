...
export const EVENTS = [
  new Event('1', '1','Event', 'The Big Levowski', 'Something to see', 'https://cdn.vox-cdn.com/thumbor/gc6X9Q45SX3JSjvjiAWaMajyR0Y=/0x0:3200x1800/1200x800/filters:focal(1341x382:1853x894)/cdn.vox-cdn.com/uploads/chorus_image/image/61474983/The_Dude5.0.jpg', new Date( 2021, 12,13,5,30 ).toString(),new Date( 2021, 12,13,7,30 ).toString(),'CineMaxx','KEA Films'),
  new Event('2', '1','Event','UCL', 'Go city!', 'https://i.ytimg.com/vi/4iwH75lgMTM/maxresdefault.jpg',new Date( 2021, 12,13,5,30 ).toString(), new Date( 2021, 12,13,10,30 ).toString(), 'Sports & Beers', 'Sports Club'),
  new Event('3', '2', 'Event','Paintball', 'The organizationName here ','https://funguide.dk/wp-content/uploads/2014/09/Paintball.jpg', new Date( 2020, 12,13,5,30 ).toString(), new Date( 2021, 12,13,7,30 ).toString(), 'Paintball Arena', 'KEA Something')
];
